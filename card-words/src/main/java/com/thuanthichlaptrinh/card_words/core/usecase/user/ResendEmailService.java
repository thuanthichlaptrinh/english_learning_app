...
public class ResendEmailService {
    ...
    // Resend test email - không cần verify domain
    private static final String FROM_EMAIL = "Card Words <onboarding@resend.dev>";
    ...
    public boolean sendEmail(String to, String subject, String htmlContent) {
        if (!isEnabled()) {
            log.warn("⚠️ Resend API key not configured");
            return false;
        }
